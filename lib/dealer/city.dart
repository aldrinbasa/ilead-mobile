...
class _CityPageState extends State<CityPage> {
  ...
  void sendSMSValue() async {
    if (phoneNumberTextController.text != '' &&
      ...
      print("City Invalid Form");
    }
  }

  void updateCommand() {
    command =
        "CITY ${phoneNumberTextController.text}/${codeTextController.text}/${passwordTextController.text}/${nameTextController.text}/${usernameTextController.text}/${birthdayTextController.text}/${addressTextController.text}";
  }
