...
class ProvincialPage extends StatefulWidget {
  const ProvincialPage({Key? key}) : super(key: key);

  @override
  State<ProvincialPage> createState() => _ProvincialPageState();
}
...
class _ProvincialPageState extends State<ProvincialPage> {
  ...
  void sendSMSValue() async {
    if (phoneNumberTextController.text != '' &&
      ...
      print("Provincial Invalid Form");
    }
  }

  void updateCommand() {
    command =
        "PROVINCIAL ${phoneNumberTextController.text}/${codeTextController.text}/${passwordTextController.text}/${nameTextController.text}/${usernameTextController.text}/${birthdayTextController.text}/${addressTextController.text}";
  }
            ...
            Container(
              child: Column(
                children: [
                  ...
                  Text(
                    "Activate a Provincial Stockiest",
                    style: TextStyle(
                        fontSize: 18,
