...
class _RetailerPageState extends State<RetailerPage> {
  ...
  void updateCommand() {
    command =
        "RET ${phoneNumberTextController.text}/${passwordTextController.text}/${nameTextController.text}/${usernameTextController.text}/${birthdayTextController.text}/${addressTextController.text}";
  }
