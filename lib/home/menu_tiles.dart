        ...
        Center(
          child: Wrap(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {Navigator.of(context).push(routeManager.routeTo(() => LoadingPage()));},
                child: loadingCard,
              ),
              GestureDetector(
                onTap: () {Navigator.of(context).push(routeManager.routeTo(() => WalletPage()));},
                child: walletCard,
              ),
              GestureDetector(
                onTap: () {Navigator.of(context).push(routeManager.routeTo(() => OthersPage()));},
                child: othersCard,
              ),
              GestureDetector(
                onTap: () {Navigator.of(context).push(routeManager.routeTo(() => DealerPage()));},
                child: dealerCard,
              ),
              // GestureDetector(
